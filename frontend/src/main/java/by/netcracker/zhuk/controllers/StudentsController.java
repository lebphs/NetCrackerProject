...
public class StudentsController {
    ...
    @ResponseBody
    public List<StudentViewModel> getStudentAsModelWithView() {
        ...
        return (List<StudentViewModel>) conversionService.convert(students, studentEntityDescriptor, studentViewModelDescriptor);
